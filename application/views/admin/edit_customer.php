    ...
    <div class="card o-hidden border-0 my-5 col-lg-12 mx-auto">
        <form method="post" class="my-3 mx-3" id="submit" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="customer_address" name="customer_address" placeholder="Enter customer address..." value="<?= $customer['customer_address']; ?>">
            ...
            <div class="form-group">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control form-control-user" name="customer_phoneno" placeholder="Enter a phone number..." value="<?= $customer['customer_phoneno']; ?>">
