    ...
    <div class="card center o-hidden border-0 my-5 mx-auto">
        <form class="my-3 mx-3" method="post" action="<?= base_url('sizes/add_sizes'); ?>">
            <div class="form-group">
                <label for="size_name">Full Name</label>
                <input type="text" class="form-control form-Dcontrol-user" id="size_name" name="size_name" placeholder="Full Name" value="<?= set_value('size_name') ?>">
